...
//         className="mb-4"
//       />
//       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 absolute">
//         {filteredProducts.map((product) => (
//           <Card key={product._id}>
//               <Button
//           onClick={() => handleToggleFavorite( product._id, product.isFavorite)}
//           className="top-4 right-4 p-2 rounded-full  bg-opacity-80 hover:bg-opacity-100 transition z-10"
//         >
//           {product.isFavorite ? (
